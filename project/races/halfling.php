...
<div class="container">
  ...
  <h1 class="mt-4 mb-3">Halflings</h1>

  <ol class="breadcrumb">
    <li class="breadcrumb-item">
      <a href="fennecology.com/bacs200/projects">Home</a>
    </li>
    <li class="breadcrumb-item active">halfling</li>
  </ol>
...
Halflings are inveterate opportunists. They firmly believe they can turn any situation to their advantage, and sometimes gleefully leap into trouble without any solid plan to extricate themselves if things go awry. Often unable to physically defend themselves from the rigors of the world, they know when to bend with the wind and when to hide away. Yet halflings’ curiosity often overwhelms their good sense, leading to poor decisions and narrow escapes. While harsh experience sometimes teaches halflings a measure of caution, it rarely makes them completely lose faith in their luck or stop believing that the universe, in some strange way, exists for their entertainment and would never really allow them to come to harm. Though their curiosity drives them to seek out new places and experiences, halflings possess a strong sense of hearth and home, often spending above their means to enhance the comforts of domestic life. Without a doubt, halflings enjoy luxury and comfort, but they have equally strong reasons to make their homes a showcase. Halflings consider this urge to devote time, money, and energy toward improving their dwellings a sign of both respect for strangers and affection for their loved ones. Whether for their own blood kin, cherished friends, or honored guests, halflings make their homes beautiful in order to express their feelings toward those they welcome inside. Even traveling halflings typically decorate their wagons or carry a few cherished keepsakes to adorn their campsites.
    ...
    <div>
      <br>
      <b>Physical Description:</b> Halflings rise to a humble height of 3 feet. They prefer to walk barefoot, leading the bottoms of their feet to become roughly calloused. Tufts of thick, curly hair warm the tops of their broad, tanned feet.
...
Female Names: Anafa, Bellis, Etune, Filiu, Irlana, Marra, Pressi, Rilka, Sistra, Wyssal, Yamyra.
  ...
  <ul>
    <li><b>Ability Score Modifiers:</b>  Halflings are nimble and strong-willed, but their small stature makes them weaker than other races. They gain +2 Dexterity, +2 Charisma, and –2 Strength.</li>
    <li><b>Size:</b>  Halflings are Small creatures and gain a +1 size bonus to their AC, a +1 size bonus on attack rolls, a –1 penalty to their CMB and CMD, and a +4 size bonus on Stealth checks.</li>
    <li><b>Type:</b>Halflings are humanoids with the Halfling subtype.</li>
    <li><b>Base Speed:</b> Halflings have a base speed of 20 feet.</li>
    <li><b>Languages:</b>Halflings begin play speaking Common and Halfling. Halflings with high Intelligence scores can choose from the following: Dwarven, Elven, Gnome, and Goblin. See the Linguistics skill page for more information about these languages.</li>
    <li><b>Fearless:</b> Halflings receive a +2 racial bonus on all saving throws against fear. This bonus stacks with the bonus granted by halfling luck.</li>
    <li><b>Halfling Luck:</b> Halflings receive a +1 racial bonus on all saving throws.</li>
    <li><b>Sure-Footed:  </b>  Halflings receive a +2 racial bonus on Acrobatics and Climb checks.</li>
  ...
  <h3>Racial Feats</h3>
    ...
    <li>Cautious Fighter</li>
    <li>Childlike</li>
    <li>Courageous Resolve</li>
    <li>Desperate Swing</li>
    <li>Fortunate One</li>
    <li>Halfling Slinger</li>
    <li>Improved Low Blow</li>
    <li>Lucky Halfling</li>
    <li>Lucky Healer</li>
    <li>Lucky Strike</li>
    <li>Pass for Human</li>
    <li>Risky Striker</li>
    <li>Sure and Fleet</li>
    <li>Surprise Strike</li>
