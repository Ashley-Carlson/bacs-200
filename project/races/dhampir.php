...
<div class="container">
  ...
  <br><br><br><br><br>
  <h1 class="mt-4 mb-3">Aasimar</h1>

  <ol class="breadcrumb">
    <li class="breadcrumb-item">
      <a href="fennecology.com/bacs200/projects">Home</a>
    </li>
    <li class="breadcrumb-item active">Aasimar</li>
  </ol>
...
Non-human aasimars have the same statistics as human aasimars with the exception of size. Thus a halfling aasimar is Small but otherwise possesses the same statistics and abilities as a human aasimar—the difference is purely cosmetic. Non-human aasimars do not possess any of the racial abilities of their base race. However, they are usually raised in the same cultural context as other members of their base race, and thus generally adopt the same fighting style as their peers, use the same types of weapons and armor, and study the same skills.</p>
    </div>
    <h2>Racial Traits</h2>
  </div>
  <ul>
    <li><b>Ability Score Modifiers:</b>  Aasimars are insightful, confident, and personable. They gain +2 Wisdom and +2 Charisma.</li>
    <li><b>Size:</b>Aasimars are Medium creatures and thus have no bonuses or penalties due to their size.</li>
    <li><b>Type:</b>Aasimars are outsiders with the native subtype.</li>
    <li><b>Base Speed:</b> Aasimars have a base speed of 30 feet.</li>
    <li><b>Languages:</b> Aasimars begin play speaking Common and Celestial. Aasimars with high Intelligence scores can choose from the following languages: Draconic, Dwarven, Elven, Gnome, Halfling, and Sylvan. See the Linguistics skill page for more information about these languages.</li>
    <li><b>Celestial Resistance:</b> Aasimars have acid resistance 5, cold resistance 5, and electricity resistance 5.</li>
    <li><b>Skilled:</b> Drow possess spell resistance (SR) equal to 6 plus their total number of class levels.</li>
    <li><b>Keen Senses:</b>  Drow gain a +2 racial bonus on Perception checks.</li>
    <li><b>Weapon Familiarity:</b>Drow are proficient with the hand crossbow, rapier, and shortsword.</li>
    <li><b>Spell-Like Abilities (Su)</b>  Drow can cast dancing lights, darkness, and faerie fire, once each per day, using their total character level as caster level.</li>
    <li><b>Poison Use:</b>Drow are skilled in the use of poisons and never risk accidentally poisoning themselves.</li>
    <li><b>Superior Darkvision: </b>Drow have superior darkvision, allowing them to see perfectly in the dark up to 120 feet.</li>
  ...
  <h3>Racial Feats</h3>
    ...
    <li>Angelic Blood</li>
    <li>Angelic Flesh</li>
    <li>Celestial Servant</li>
    <li>Blinding Light</li>
    <li>Channel Force</li>
    <li>Channel Force, Greater</li>
    <li>Channel Force, Improved</li>
    <li>Consecrate Spell (Metamagic)</li>
    <li>Heavenly Radiance</li>
    <li>Inner Light</li>
    <li>Metallic Wings</li>
    <li>Revered Guidance</li>
    <li>Supernal Feast</li>
    <li>Sunlit Strike</li>
