...
<br><br><br><br><br>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Half Orcs</li>
  </ol>
...
Female names: Canan, Drogheda, Goruza, Mazon, Shirish, Tevaga, Zeljka.
  ...
  <ul>
    <li><b>Ability Score Modifiers:</b> Half-orc characters gain a +2 bonus to one ability score of their choice at creation to represent their varied nature.</li>
    <li><b>Size:</b> Half-orcs are Medium creatures and thus have no bonuses or penalties due to their size.</li>
    <li><b>Type:</b> Half-orcs are Humanoid creatures with both the human and orc subtypes.</li>
    <li><b>Base Speed:</b> Half-orcs have a base speed of 30 feet.</li>
    <li><b>Languages:</b>Half-orcs begin play speaking Common and Orc. Half-orcs with high Intelligence scores can choose from the following: Abyssal, Draconic, Giant, Gnoll, and Goblin. See the Linguistics skill page for more information about these languages.</li>
    <li><b>Intimidating:</b> Half-orcs receive a +2 racial bonus on Intimidate checks due to their fearsome nature.</li>
    <li><b>Orc Ferocity:</b> Once per day, when a half-orc is brought below 0 hit points but not killed, he can fight on for 1 more round as if disabled. At the end of his next turn, unless brought to above 0 hit points, he immediately falls unconscious and begins dying.</li>
  ...
  <h3>Racial Feats</h3>
    ...
    <li>Brutal Grappler</li>
  <li>Deathless Initiate</li>
    <li>Deathless Master</li>
    <li>Deathless Zealot</li>
    <li>Destroyer’s Blessing</li>
    <li>Ferocious Resolve</li>
    <li>Ferocious Summons</li>
    <li>Ferocious Tenacity</li>
    <li>Fight On</li>
    <li>Fire God’s Blessing</li>
    <li>Gore Fiend</li>
    <li>Horde Charge</li>
    <li>Ironguts</li>
    <li>Ironhide</li>
    <li>Keen Scent</li>
    <li>Pass for Human</li>
    <li>Razortusk</li>
    <li>Resilient Brute</li>
    <li>Smash</li>
    <li>Smell Fear</li>
    <li>Surprise Follow-Through</li>
    <li>Surprise Follow-Through, Improved</li>
    <li>Sympathetic Rage</li>
    <li>Tenacious Survivor</li>
    <li>Thrill of the Kill</li>
    <li>War Singer</li>
</div>
<?php
// add footer
