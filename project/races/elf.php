...
<br>
    ...
    <br>
    <b>Relations:</b> Elves are prone to dismissing other races, writing them off as rash and impulsive, yet on an individual level, they are excellent judges of character. In many cases an elf will come to value a specific member of another race, seeing that individual as deserving and respectable, while still dismissing the race as a whole. If called on this behavior, the elf often doesn’t understand why his “special friend” is upset the elf has noticed the friend is “so much better than the rest of his kind.” Even elves who see such prejudice for what it is must constantly watch themselves to prevent such views from coloring their thinking.
...
Female Names: Amrunelara, Dardlara, Faunra, Jathal, Merisiel, Oparal, Soumral, Tessara, Yalandlara.
  ...
  <ul>
    <li><b>Ability Score Modifiers:</b> Elves are nimble, both in body and mind, but their form is frail. They gain +2 Dexterity, +2 Intelligence, and –2 Constitution.</li>
    <li><b>Size:</b>  Elves are Medium creatures and thus receive no bonuses or penalties due to their size.</li>
    <li><b>Type:</b>Elves are Humanoids with the elf subtype.</li>
    <li><b>Base Speed:</b> Elves have a base speed of 30 feet.</li>
    <li><b>Languages:</b>Elves begin play speaking Common and Elven. Elves with high Intelligence scores can choose from the following: Celestial, Draconic, Gnoll, Gnome, Goblin, Orc, and Sylvan. See the Linguistics skill page for more information about these languages.</li>
    <li><b>Elven Immunities:</b> Elves are immune to magic sleep effects and gain a +2 racial saving throw bonus against enchantment spells and effects.</li>
    <li><b>Keen Senses:</b>Elves receive a +2 racial bonus on Perception checks.</li>
    <li><b>Elven Magic: </b> Elves receive a +2 racial bonus on caster level checks made to overcome spell resistance. In addition, elves receive a +2 racial bonus on Spellcraft skill checks made to identify the properties of magic items.</li>
