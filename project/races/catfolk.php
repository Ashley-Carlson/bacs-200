...
Female Names: Alyara, Duline, Hoya, Jilyana, Milah, Miniri, Siphelele, Tiyeri.
  ...
  <ul>
    <li><b>Ability Score Modifiers:</b> Catfolk are sociable and agile, but often lack common sense. They gain +2 Dexterity, +2 Charisma, –2 Wisdom.</li>
    <li><b>Size:</b>Catfolk are Medium creatures and have no bonuses or penalties due to their size.</li>
    <li><b>Type:</b> Catfolk are humanoids with the catfolk subtype.</li>
    <li><b>Base Speed:</b> Catfolk have a base speed of 30 feet.</li>
    <li><b>Languages:</b> Catfolk begin play speaking Common and Catfolk. Catfolk with high Intelligence scores can choose from the following languages: Elven, Gnoll, Gnome, Goblin, Halfling, Orc, and Sylvan.</li>
    <li><b>Cat’s Luck:</b>  Once per day when a catfolk makes a Reflex saving throw, he can roll the saving throw twice and take the better result. He must decide to use this ability before the saving throw is attempted.</li>
    <li><b>Natural Hunter:</b> Catfolk receive a +2 racial bonus on Perception, Stealth, and Survival checks.</li>
    <li><b>Sprinter:</b> Catfolk gain a 10-foot racial bonus to their speed when using the charge, run, or withdraw actions.</li>
    <li><b>Low-Light Vision:</b>Catfolk have low-light vision allowing them to see twice as far as humans in dim light.</li>
    <!-- /.row -->

  <h3>Racial Feats</h3>

    <li>Black Cat</li>
    <li>Catfolk Exemplar</li>
    <li>Claw Pounce</li>
    <li>Nimble Striker</li>
    <li>Feline Grace</li>
