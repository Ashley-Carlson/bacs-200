...
<div class="container">
  ...
  <h1 class="mt-4 mb-3">Humans</h1>

  <ol class="breadcrumb">
    <li class="breadcrumb-item">
      <a href="fennecology.com/bacs200/projects">Home</a>
    </li>
    <li class="breadcrumb-item active">Humans</li>
  </ol>
...
Male Names: Aakif, Andrezi, Arasmes, Bahram, Baolo, Barid, Batsaikhan, Belor, Budi, Darvan, Dolok, Eilif, Garidan, Gellius, Hadzi, Hamengku, Harisko, Iacobus, Jaali, Jianguo, Kjell, Kousei, Kronug, Menas, Mitabu, Narsius, Nonek, Pateba, Pratavh, Qorchi, Ragnar, Rubani, Seckor, Shokamb, Shuo, Sunaki, Suryo, Tabansi, Teruawa, Thanh Liem, Toan Hao, Tomorbataar, Tuong Kinh, Ursion, Vachedi, Viorec, Yekskya, Zaiho, Zhen.
  ...
  <ul>
    <li><b>Ability Score Modifiers:</b> Human characters gain a +2 racial bonus to one ability score of their choice at creation to represent their varied nature.</li>
    <li><b>Size:</b> Humans are Medium creatures and thus receive no bonuses or penalties due to their size</li>
    <li><b>Type:</b>Humans are humanoids with the human subtype.</li>
    <li><b>Base Speed:</b> Humans have a base speed of 30 feet..</li>
    <li><b>Languages:</b>Humans begin play speaking Common. Humans with high Intelligence scores can choose any languages they want (except secret languages, such as Druidic). See the Linguistics skill page for more information about these languages.</li>
    <li><b>Bonus Feat:</b> Humans select one extra feat at 1st level.</li>
    <li><b>Skilled:</b> Humans gain an additional skill rank at first level and one additional rank whenever they gain a level.</li>
    <!-- /.row -->
  <h2>Racial Feats</h2>

    <li>Bestow Luck</li>
    <li>Critical Versatility</li>
    <li>Dauntless Destiny</li>
    <li>Defiant Luck</li>
    <li>Eclectic</li>
    <li>Fast Learner</li>
    <li>Fearless Curiosity</li>
    <li>Heroic Will</li>
    <li>Huntmaster</li>
    <li>Improved Improvisation</li>
    <li>Improvisation</li>
    <li>Inexplicable Luck</li>
    <li>Intimidating Confidence</li>
    <li>Martial Mastery</li>
    <li>Martial Versatility</li>
    <li>Planar Heritage</li>
    <li>Racial Heritage</li>
    <li>Surge of Success</li>
